...
<div class="mainbody">
    ...
    <form method="get" action="${pageContext.request.contextPath}/staff/appointment/request">
        <div class="search-controls">
            ...
            <input type="date" name="appointmentDate" id="appointmentDate" value="${param.appointmentDate}" />
            ...
            <a href="${pageContext.request.contextPath}/staff/appointment/request" class="btn">Reset</a>
        </div>
    </form>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" 
                                    class="action-link approve-btn" 
                                    data-id="${appt.id}" 
                                    data-action="approve"
                                    data-customer="${appt.customer.name}"
                                    title="Approve Appointment">
                                    <span class="material-icons icon-action">check_circle</span>
                                </a>
                                <a href="javascript:void(0);" 
                                    class="action-link reject-btn" 
                                    data-id="${appt.id}" 
                                    data-action="reject"
                                    data-customer="${appt.customer.name}"
                                    title="Reject Appointment">
                                    <span class="material-icons icon-action">cancel</span>
                                </a>
                            </td>
                        </tr>
                    </c:forEach>
...
<div id="actionModal" class="modal">
    <div class="modal-content">
        ...
        <form id="actionForm" method="post" action="${pageContext.request.contextPath}/staff/appointment/request">
...
<script>
    document.querySelectorAll('.approve-btn, .reject-btn').forEach(btn => {
        btn.addEventListener('click', function () {
            ...
            const customer = this.getAttribute('data-customer') || 'this appointment';
            ...
            title.innerHTML = action === 'approve' ? 'Confirm Approval' : 'Confirm Rejection';
            msg.innerHTML = `Are you sure you want to ${action} appointment for <strong>${customer}</strong>?`;
