...
<form method="get" action="${pageContext.request.contextPath}/staff/customer">
    ...
    <a href="${pageContext.request.contextPath}/staff/customer">Reset</a>
    <a href="${pageContext.request.contextPath}/staff/customer/new" class="btn">+ Create New Customer</a>
    ...
    <tbody>
        <c:forEach var="cust" items="${customerList}">
            <tr>
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/staff/customer/detail?id=${cust.id}">Detail</a> |
                    <a href="${pageContext.request.contextPath}/staff/customer/delete?id=${cust.id}"
