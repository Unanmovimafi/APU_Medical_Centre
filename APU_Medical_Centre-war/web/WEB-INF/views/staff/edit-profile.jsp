...
<style>
    ...
    .form-table td:first-child {
        width: 120px; /* Reduce as needed (e.g. 100px or 120px) */
        white-space: nowrap;
    }
...
<div class="mainbody">
    ...
    <div class="container">
        <div class="form-section">
            <form action="${pageContext.request.contextPath}/staff/edit-profile" method="post" id="editProfileForm">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="field-wrapper">
                                ...
                                <input type="text" name="name" value="${staff.name}" class="editable" required />
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="field-wrapper">
                                ...
                                <input type="email" name="email" value="${staff.email}" class="editable" required/>
                            </div>
                        </td>
                    </tr>
                    <tr>
...
<!--                                <input type="text" name="phoneNumber" value="${staff.phoneNumber}" class="editable" required-->
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="field-wrapper">
                                ...
                                <input type="password" name="newPassword" id="newPassword" placeholder="Leave blank to keep unchanged" minlength="8" class="editable" />
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="field-wrapper">
                                ...
                                <input type="password" name="oldPassword" id="oldPassword" placeholder="Enter current password" class="editable" style="display: none;" />
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                <div class="button-footer" id="saveCancelWrapper" style="display: none;">
                    ...
                    <button type="button" id="cancelBtn" onclick="disableEdit()">Cancel</button>
                </div>
        ...
        <div class="picture-section">
            ...
            <form method="post" action="${pageContext.request.contextPath}/staff/edit-profile-picture"
...
<script>
    ...
    document.getElementById('editProfileForm').addEventListener('submit', function (e) {
        ...
        if (newPwd.length >= 8 && !oldPwd) {
            showCustomAlert("Please type in your previous password to change new password.", "Password Required");
    ...
    function enableEdit() {
        ...
        // ✅ Toggle wrapper visibility only
    ...
    function disableEdit() {
        document.querySelectorAll('.text-display').forEach(el => el.style.display = 'block');
        document.querySelectorAll('.editable').forEach(el => {
