  ...
  <div class="form-section">
    ...
    <c:if test="${not empty appointment}">
      <table class="form-table">
        <tr>
          ...
          <td>
            <input type="text" value="${appointment.customer.name}" readonly />
          </td>
        </tr>
        <tr>
          <td><strong>Customer Email :</strong></td>
          <td>
            <input type="text" value="${appointment.customer.email}" readonly />
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <input type="text" value="${appointment.doctor.name}" readonly />
          </td>
        </tr>
        <c:if test="${not empty appointment.doctor.phoneNumber}">
          <tr>
        ...
        <tr>
          ...
          <td>
            <input
              type="text"
              value="<fmt:formatDate value='${appointment.appointmentStartDatetime}' pattern='EEEE, dd MMMM yyyy'/>"
              readonly
            />
          </td>
        </tr>
        <tr>
          ...
          <td>
            <input
              type="text"
              value="<fmt:formatDate value='${appointment.appointmentStartDatetime}' pattern='HH:mm'/>"
              readonly
            />
          </td>
        </tr>
        <tr>
          ...
          <td>
            <input
              type="text"
              value="<fmt:formatDate value='${appointment.appointmentEndDatetime}' pattern='HH:mm'/>"
              readonly
            />
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <input
              type="text"
              value="<fmt:formatDate value='${appointment.creationDatetime}' pattern='dd/MM/yyyy HH:mm'/> by ${appointment.createBy}"
              readonly
            />
          </td>
        </tr>
        <tr>
          ...
          <td>
            <input
              type="text"
              value="<c:choose><c:when test='${appointment.lastUpdateDatetime != null}'><fmt:formatDate value='${appointment.lastUpdateDatetime}' pattern='dd/MM/yyyy HH:mm'/> by ${appointment.lastUpdateBy}</c:when><c:otherwise>Not updated yet</c:otherwise></c:choose>"
              readonly
            />
          </td>
        </tr>
    ...
    <c:if test="${empty appointment}">
      <div class="error-message">
        ...
        <p>
          The requested appointment could not be found. Please check the
          appointment ID and try again.
        </p>
      </div>
      <div class="button-footer">
        <div style="flex: 1"></div>
