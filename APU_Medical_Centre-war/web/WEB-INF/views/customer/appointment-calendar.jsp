...
<div id="dayModal" class="modal">
  <div class="modal-content">
    <div class="modal-header">
      <h3 id="modalDate">My Appointments for Selected Date</h3>
...
<script>
              ...
              if (week === 0 && day < startingDayOfWeek) {
                  ...
                  if (dayAppointments.length > 0) {
                      ...
                      dayAppointments.slice(0, 3).forEach(appt => {
                          ...
                          appointmentDiv.innerHTML = appt.timeStart + ' - ' + appt.doctor.substring(0, 8) + (appt.doctor.length > 8 ? '...' : '');
  ...
  function changeMonth(delta) {
      ...
      window.location.href = '${pageContext.request.contextPath}/customer/appointment/calendar?year=' + year + '&month=' + month;
  }
  ...
  function showDayDetails(dateStr, dayAppointments) {
      ...
      modalDate.textContent = 'My Appointments for ' + date.toLocaleDateString('en-US', options);
      ...
      if (dayAppointments.length === 0) {
          ...
          dayAppointments.forEach(appt => {
              ...
              tableHTML += '<tr>' +
                  ...
                  '<td><a href="${pageContext.request.contextPath}/customer/appointment/detail?id=' + appt.id + '&from=calendar" style="color: #00BFFF; text-decoration: none;">View Details</a></td>' +
                  '</tr>';
          });
