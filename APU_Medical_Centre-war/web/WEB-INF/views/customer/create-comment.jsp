...
<div class="mainbody">
    ...
    <div class="form-section">
        <form action="${pageContext.request.contextPath}/customer/comment/new" method="POST" id="commentForm">
            <input type="hidden" name="selectedUserId" id="selectedUserId" value="">
            <input type="hidden" name="selectedStaffRole" id="selectedStaffRole" value="">
...
<script type="text/javascript">
    ...
    function saveUser() {
        ...
        if (!selectedRadio) {
            ...
            var staffRole = selectedRadio.getAttribute('data-role');
            var row = selectedRadio.closest("tr");
            var userName = row.cells[2].textContent;

            // Store the ID and role in the hidden fields for form submission
            document.getElementById("selectedUserId").value = userId;
            document.getElementById("selectedStaffRole").value = staffRole;
