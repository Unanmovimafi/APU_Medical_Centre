...
<!--                <input
                ...
                />-->
                                ...
                                <input class="editable" type="tel" name="phoneNumber" value="${customer.phoneNumber}" pattern="^\d{10,11}$" title="Please enter numbers only" oninput="this.value = this.value.replace(/[^0-9]/g, '')" maxlength="11" required/>
