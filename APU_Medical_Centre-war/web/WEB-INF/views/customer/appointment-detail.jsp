        ...
        <c:if test="${not empty appointment}">
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td><input type="text" value="${appointment.doctor.email}" readonly /></td>
                </tr>
                <c:if test="${not empty appointment.doctor.phoneNumber}">
                <tr>
                    <td><strong>Doctor Phone :</strong></td>
                    <td><input type="text" value="${appointment.doctor.phoneNumber}" readonly /></td>
                </tr>
                </c:if>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" value="<fmt:formatDate value='${appointment.creationDatetime}' pattern='dd/MM/yyyy HH:mm'/>" readonly /></td>
                </tr>
                <tr>
                    <td><strong>Last Updated :</strong></td>
                    <td>
                        <input type="text" value="<c:choose><c:when test='${appointment.lastUpdateDatetime != null}'><fmt:formatDate value='${appointment.lastUpdateDatetime}' pattern='dd/MM/yyyy HH:mm'/><c:if test='${not empty appointment.lastUpdateBy}'> by ${appointment.lastUpdateBy}</c:if></c:when><c:otherwise>Not updated yet</c:otherwise></c:choose>" readonly />
                    </td>
                </tr>
            </table>
