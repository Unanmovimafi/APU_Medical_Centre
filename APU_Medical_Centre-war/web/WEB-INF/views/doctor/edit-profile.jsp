...
<div class="mainbody">
  ...
  <div class="container">
    <div class="form-section">
      <form
        action="${pageContext.request.contextPath}/doctor/edit-profile"
        method="post"
        id="editProfileForm"
      >
        ...
        <table class="form-table">
          <tr>
            ...
            <td>
              <div class="field-wrapper">
                <span class="text-display">${doctor.name}</span>
                <input
                  type="text"
                  name="name"
                  value="${doctor.name}"
          ...
          <tr>
            ...
            <td>
              <div class="field-wrapper">
                <span class="text-display">${doctor.email}</span>
                <input
                  type="email"
                  name="email"
                  value="${doctor.email}"
    ...
    <div class="picture-section">
      ...
      <c:choose>
        <c:when test="${not empty doctor.profilePicture}">
          <img src="${doctor.profilePicture}" alt="Profile Picture" />
        </c:when>
        <c:otherwise>
      ...
      <form
        method="post"
        action="${pageContext.request.contextPath}/doctor/edit-profile-picture"
