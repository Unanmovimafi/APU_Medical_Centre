...
<script>
  ...
  function changeMonth(delta) {
      ...
      window.location.href = '${pageContext.request.contextPath}/doctor/appointment/list?year=' + year + '&month=' + month;
  }
      ...
      if (dayAppointments.length === 0) {
          ...
          dayAppointments.forEach(appt => {
              ...
              tableHTML += '<tr>' +
                  ...
                  '<td><a href="${pageContext.request.contextPath}/doctor/appointment/detail?id=' + appt.id + '" style="color: #00BFFF; text-decoration: none;">View Details</a></td>' +
                  '</tr>';
          });
