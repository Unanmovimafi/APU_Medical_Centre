 ...
 * @author khong
 */
@WebServlet(name = "DoctorCustomerList", urlPatterns = {"/doctor/customer/list"})
public class DoctorCustomerList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DoctorCustomerList</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DoctorCustomerList at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Customer> customers = appointmentFacade.findCustomersByDoctor(loggedDoctor);
        ...
        request.setAttribute("pageContent", "/WEB-INF/views/doctor/customer-list.jsp");
