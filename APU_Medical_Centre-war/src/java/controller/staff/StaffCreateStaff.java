...
public class StaffCreateStaff extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet StaffCreateStaff</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet StaffCreateStaff at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            staff.setCreateBy("admin");
            staff.setLastUpdateBy("admin");
            ...
            System.err.println("[ERROR] Failed to create staff: " + e.getMessage());
            request.setAttribute("error", "Failed to create staff.");
            request.setAttribute("pageContent", "/WEB-INF/views/staff/create-staff.jsp");
            request.getRequestDispatcher("/WEB-INF/layout/layout.jsp").forward(request, response);
        }
    }
