...
@WebServlet(name = "ManagerAppointmentDetail", urlPatterns = { "/manager/appointment/detail" })
public class ManagerAppointmentDetail extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (idParam == null || idParam.trim().isEmpty()) {
            ...
            response.sendRedirect(request.getContextPath() + "/manager/appointment/list");
            return;
        }
        ...
        try {
            ...
            request.setAttribute("pageContent", "/WEB-INF/views/manager/appointment-detail.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("approve".equals(action) && "PENDING".equals(currentStatus)) {
                ...
                response.sendRedirect(request.getContextPath() + "/manager/appointment/receipt?id=" + appointmentId);
                return;
            ...
            response.sendRedirect(request.getContextPath() + "/manager/appointment/detail?id=" + appointmentId);
            ...
            response.sendRedirect(request.getContextPath() + "/manager/appointment/detail?id=" + idParam);
        }
    }
