...
//            if (session == null || session.getAttribute("customerSession") == null || session.getAttribute("managerSession") == null || session.getAttribute("counterStaffSession") == null || session.getAttribute("doctorSession") == null) {
